  ...
  return (
    <div>
      ...
      {filtersKey.map((filter, index) => (
        <p data-testid={`${index}-ingredient-name-and-measure`}>{dataDetail[filter]} - {dataDetail.meals[0][`strMeasure${index + 1}`]} <img src={`https://www.themealdb.com/images/ingredients/${dataDetail.meals[0][filter].toLowerCase()}-Small.png`} alt={dataDetail.meals[0][filter]} /></p>
      ))}
      <h1>Instructions</h1>
