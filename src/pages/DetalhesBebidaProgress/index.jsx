...
function renderProgress({ dataDetail, histories, id, isChecked, isNotChecked, filtersKeyOutra, isMeal, liked, setLiked, inProgress, setInProgress, isDone, setIsDone }) {
